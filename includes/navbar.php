          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.php"><span class="font-weight-bold text-uppercase text-dark">Boutique </span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link" href="shop.php?product_page=1&cat_id=0">Shop</a>
                </li>
                <!-- <li class="nav-item">
               <a class="nav-link" href="detail.php">Product detail</a>
                </li>  -->
                <li class="nav-item">
                  <!-- Link--><a class="nav-link" href="contact.php">Contact</a>
                </li>
              ...
              <ul class="navbar-nav ml-auto">               
                ...
                <li class="nav-item"><a class="nav-link" href="functions/userlogout/userlogOut.php"> <i class="fas fa-user-alt mr-1 text-gray"></i>LogOut</a></li>
              </ul>
