            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
              ...
              <div class="table-responsive mb-4">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                    $selectProCard="SELECT * FROM cards";
                    $selectProCard=$conn->query($selectProCard);
                    foreach($selectProCard as $proCard){
                    ...
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.php"><img src="img/product-detail-3.jpg" alt="..." width="70"/></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.php">
                            <?php
                              $proCardID=$proCard['pro_id'];
                              $selectProTypes="SELECT * FROM products WHERE id=$proCardID";
                              $selectProTypes=$conn->query($selectProTypes);
                              $selectProTypes=$selectProTypes->fetch_assoc();
                              echo $selectProTypes['name'];
                            ?>
                      ...
                      <td class="align-middle border-0">
                        <p class="mb-0 small">$<?=$selectProTypes['price']?></p>
                      </td>
                      <td class="align-middle border-0">
                        <div class="border d-flex align-items-center justify-content-between px-3"><span class="small text-uppercase text-gray headings-font-family">Quantity</span>
                          <div class="quantity">
                            <button class="dec-btn p-0"><i class="fas fa-caret-left"></i></button>
                            <input class="form-control form-control-sm border-0 shadow-0 p-0" type="text" value="<?=$proCard['quantity']?>"/>
                            <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle border-0">
                        <p class="mb-0 small">
                      <?php
                       echo '$' . $selectProTypes['price'] * $proCard['quantity'];
                      ?></p>
                      </td>
