        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-lg-6">
              <?php
              $pro_ID=$_GET['id'];
              $selectProductIMG="SELECT img_name FROM images WHERE pro_id=$pro_ID";
              $selectProductIMG=$conn->query($selectProductIMG);
              $selectProductIMG=$selectProductIMG->fetch_assoc();
              $imgExloded=explode(',',$selectProductIMG['img_name']);
              ?>
              <!-- PRODUCT SLIDER-->
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/pro/<?=$imgExloded[0]?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/pro/<?=$imgExloded[1]?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/pro/<?=$imgExloded[2]?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2"><img class="w-100" src="admin/images/pro/<?=$imgExloded[3]?>" alt="..."></div>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    
                    <a class="d-block" href="admin/images/pro/<?=$imgExloded[0]?>" data-lightbox="product" title="Product item 1">
                      <img class="img-fluid" src="admin/images/pro/<?=$imgExloded[0]?>" alt="...">
                    </a>

                      <a class="d-block" href="admin/images/pro/<?=$imgExloded[1]?>" data-lightbox="product" title="Product item 2">
                        <img class="img-fluid" src="admin/images/pro/<?=$imgExloded[1]?>" alt="...">
                      </a>

                        <a class="d-block" href="admin/images/pro/<?=$imgExloded[2]?>" data-lightbox="product" title="Product item 3">
                          <img class="img-fluid" src="admin/images/pro/<?=$imgExloded[2]?>" alt="...">
                        </a>

                          <a class="d-block" href="admin/images/pro/<?=$imgExloded[3]?>" data-lightbox="product" title="Product item 4">
                            <img class="img-fluid" src="admin/images/pro/<?=$imgExloded[3]?>" alt="...">
                          </a>
                  </div>
                </div>
              </div>
            ...
            <?php
            $proID=$_GET['id'];
            $selectProDetalis="SELECT * FROM products WHERE id=$proID";
            $selectProDetalis=$conn->query($selectProDetalis);
            $selectProDetalis=$selectProDetalis->fetch_assoc();
            ?>
            <!-- PRODUCT DETAILS-->
            <div class="col-lg-6">
              <ul class="list-inline mb-2">
              ...
              <h1><?=$selectProDetalis['name']?></h1>
              <p class="text-muted lead">$<?=$selectProDetalis['price']?></p>
              <p class="text-small mb-4"><?=$selectProDetalis['description']?>.</p>
              <div class="row align-items-stretch mb-4">
