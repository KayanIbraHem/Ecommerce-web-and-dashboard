    ...
    if(empty($emptyFielderrors) && empty($imgErrormassage)){
        ...
        if(isset($insertProductquery)){
            ...
            if(isset($imagesQuery)){
                $_SESSION['done']="Product  $name  added Successfully";
    ...
    if(empty($emptyFielderrors)){
        ...
        if($insertProductquery){
            ...
            $productNums=$productNums->num_rows;
                echo "<div id='$lastId' data-num='$productNums' class='alert alert-success'>Product added successfully</div>";
                   // $_SESSION['done']="Product  $name  added Successfully";
