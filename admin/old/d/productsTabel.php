					...
					<tbody>
						...
						<tr>
							...
							<!-- Start Edit Button -->
								...
								<!-- Start Delete Button -->
								<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#id<?= $product['id'] ?>">
			                        <span class="icon text-white-50">
							...
							<div class="modal-dialog">
								<div class="modal-content">
								    <div class="modal-header">
								      ...
								      <div class="modal-footer">
								        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
								        <a class="btn btn-danger " href="functions/product/delete_product.php?id=<?= $product['id'] ?>"><span class="icon text-white-50">
			                           	<i class="fas fa-trash"></i>
			                        </span>
